...
<template>
  ...
  >
    <div class="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
      <RouterLink
        to="/products"
        class="rounded-md text-lg font-semibold tracking-tight text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      >
        QBIQ Dig Store
      </RouterLink>
      <nav class="flex items-center gap-4 text-sm font-medium" aria-label="Main navigation">
        <RouterLink
          to="/products"
          class="rounded-md text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        ...
        <RouterLink
          to="/cart"
          class="relative inline-flex items-center gap-1.5 rounded-md text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          active-class="!text-foreground"
